...
class Summarizer:
    ...
    def generate_summary(
        ...
        # Create system prompt for meeting summarization context
...
"""
    ...
    def _create_system_prompt(self) -> str:
        """
        Create a system prompt to provide context about meeting summarization.

        Returns:
            System prompt string for meeting summarization
        """
        extras = os.getenv("extras", "")
...
Add watermark "GENERATED BY MEETINGER" at the end.
"""
